...
var other = function () {
    botui.message.bot({
        ...
        return botui.message.bot({
            delay: 1500,
            content: "主修的网络专业，是个啥也不会的小白"
        })
    }).then(function () {
        return botui.message.bot({
            delay: 1500,
            content: "略懂HTML/CSS/JavaScript/Java/Python/C/C++,主攻方向还没确定..."
        })
    }).then(function () {
        return botui.message.bot({
            delay: 1500,
            content: "主要工作方向：还没想好呢"
        })
    }).then(function () {
        return botui.message.bot({
            delay: 1500,
            content: "喜欢折腾,目前正在计算机一道上探索中"
        })
    }).then(function () {
        return botui.action.button({
            delay: 1500,
        ...
        return botui.message.bot({
            delay: 1500,
            content: "em，工程师、架构师、行业资深领导人物？肯定是苦逼的程序猿呀！"
        })
    }).then(function (res) {
        return botui.message.bot({
            delay: 1500,
